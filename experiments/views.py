...
EXPERIMENTS = {
    ...
    "phone-string": {
        ...
        "emoji": "📞🧵",
        "summary": "Передаємо звук по натягнутій нитці!",
        "materials": ["два стаканчики", "нитка 2–3 метри", "дві скріпки або гудзики"],
        "steps": [
            "Візьми два стаканчики й зроби в дні отвори.",
            "Просунь нитку крізь отвори та закріпи її скріпками або гудзиками.",
            "Відійдіть на відстань, щоб нитка натягнулась.",
            "Один говорить у стаканчик, інший слухає — і диво, звук передається!"
        ],
        "safety_note": "Обережно з голкою при створенні отворів.",
